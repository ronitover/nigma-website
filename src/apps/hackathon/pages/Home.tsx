      ...
      <div className="relative" style={{ zIndex: 1 }}>
        <main className="flex-1 flex items-center justify-center min-h-screen">
          <div className="text-center px-6">
            ...
            <div className="mt-12">
              <button className="bg-primary text-background-dark px-8 py-4 rounded-lg font-bold uppercase tracking-widest hover:scale-105 transition-transform shadow-[0_0_20px_rgba(201,162,77,0.5)]">
                Coming Soon
              </button>
            </div>
          </div>
